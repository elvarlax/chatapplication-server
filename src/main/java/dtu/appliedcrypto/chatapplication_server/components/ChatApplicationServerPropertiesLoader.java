 ...
 */
package dtu.appliedcrypto.chatapplication_server.components;
...
/**
 * This class file is responsible for loading all configuration properties
 * defined in the chatapplication-server.properties file stored in the "dist"
 * folder of the ChatApplicationServer project. These property values will be
 * passed to the Configuration Manager component instance in order to be
 * accessible from all other implemented components.
 * <p>
 * IMPORTANT NOTE In case of a property with a "null" (or no) value in the
 * chatapplication-server.properties file an exception will be thrown. The only
 * difference is for the LogFile property which in case of a "null" value, the
 * LogViewer component redirects logging to the standard Java output.
 *
 * @author atgianne
 */
public class ChatApplicationServerPropertiesLoader implements IComponent {
    ...
    /**
     * Make sure that we can only get one instance of the LSCSPropertiesLoader
    ...
    /**
     * Implementation of the IComponent.initialize method. Load all the
     * configuration properties from the lotus-server.properties file and pass them
     * to the Configuration Manager component.
     *
    ...
    public void initialize() throws ComponentInitException, PropertyLoadException {
        ...
        try {
             ...
             * ConnectionHandling poll for handling any received socket connections
             */
             ...
             * then the default value is 1500
             */
    ...
    /**
     * Method for checking the value of a loaded property from the
     * chatapplication-server.properties file. If the value is not "null", it is
     * passed to the Configuration Manager component in order to be accessible from
     * all other components; otherwise a false statement is returned.
     *
