 ...
 * components. It also handles gracefull error recovery by terminating any
 * running components and then quitting the program with an exit code equal to
 * 1.
 *
 * @author atgianne
 */
public class ComponentManager {
    ...
    /**
     * Boolean flag set to TRUE if we are throwing a fatalException This avoids
     * cascading loops of fatalExceptions
     */
    ...
    /**
     * Creates a new instance of ComponentManager. Make sure that we can only get an
     * instance of the ComponentManger by only invoking the getInstance() method.
     */
    ...
    /**
     * Implementation of the getInstance() method. It returns the running instance
     ...
     *
     * @param componentNames A list containing the names of the components to be
     *                       started
    ...
    /**
     * Shut down all the active ChatApplicationServer components in the reverse
     * order from which they were started.
     */
    ...
    /**
     * Method invoked when a fatal exception occurs. Cleanly shut down the LSCS
     * system and exit.
     *
