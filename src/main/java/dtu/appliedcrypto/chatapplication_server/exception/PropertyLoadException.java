 ...
 */
package dtu.appliedcrypto.chatapplication_server.exception;

/**
 * This kind of exception is thrown whenever an attempt to load an invalid
 * configuration property given by the user when booting up the ChatApplication
 * Server side.
 * <p>
...
public class PropertyLoadException extends Exception {
    ...
    /**
     * Method for returning the correct name of the property value as used in the
     * lotus-system.propery file.
     *
